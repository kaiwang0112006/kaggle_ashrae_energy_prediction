...
for_prediction = get_keras_data(test, numericals, categoricals)
res = np.expm1(sum([model.predict(for_prediction, batch_size=1024)[:,0] for model in models])/folds)

submission = pd.read_csv('submitm5v1.csv')
submission['meter_reading'] = res
submission.loc[submission['meter_reading']<0, 'meter_reading'] = 0
submission.to_csv('submitm5v2.csv', index=False)
